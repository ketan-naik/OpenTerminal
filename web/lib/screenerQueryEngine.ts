/**
 * Stock Screener Query Engine: Lexer, Parser & AST Evaluator (Client).
 */

import { findMetric, METRIC_REGISTRY } from "./metricRegistry";
import { ScreenerRow, ScreenerPrebuilt } from "./screenerTypes";
